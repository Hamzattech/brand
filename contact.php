...
<body>
    <nav class="navbar navbar-expand-lg navbar-light ">
        <a href="" class="navbar-brand " style="color: navy;"><img src="images/tecspot.png" alt="band-image" width="" height=""></a>
        <button class="navbar-toggler" style="background-color: white; color: navy;" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"> 
            <span class="navbar-toggler-icon"  ><i class="fas fa-bars fa-1" style="color:navy; font-size:28px;" id="new-toggler"></i>
            </span>
        </button>
...
<br>
    <div class="container">
        <h1 class="page-header text-center " id="contactUs">Contact us</h1>
        <form action="" class="form-group col-md-6 col-sm-12 col-12 ">
    ...
    <div class="card-footer ">
        <p class="text-center"> <span class="footer-text"></span> &copy; Tecspot all right reserved</p>
    </div>
